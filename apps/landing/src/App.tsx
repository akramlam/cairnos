...
const RELEASES = 'https://github.com/akramlam/cairnos/releases/latest';
const REPO = 'https://github.com/akramlam/cairnos';
const PREVIEW = `${import.meta.env.BASE_URL}preview.png`;
...
export function App() {
  return (
    <div className="min-h-screen overflow-x-hidden">
        ...
        <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-6">
          ...
          <div className="flex items-center gap-2">
            <Button asChild variant="ghost" size="sm">
              <a href={REPO} target="_blank" rel="noreferrer" className="gap-1.5">
                <Github className="size-4" /> GitHub
              </a>
            </Button>
            <Button asChild variant="brand" size="sm">
              <a href={RELEASES} target="_blank" rel="noreferrer" className="gap-1.5">
                <HardDriveDownload className="size-4" /> Download
              </a>
            </Button>
          </div>
        </div>
      ...
      <section className="relative mx-auto max-w-6xl px-6 pb-10 pt-20 text-center">
        ...
        >
          ...
          <p className="mx-auto mt-5 max-w-2xl text-lg text-muted-foreground">
            ...
            projects, tasks, notes, and reminders - all on your own machine.
          </p>
          <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
            <Button asChild variant="brand" size="lg" className="gap-2">
              <a href={RELEASES} target="_blank" rel="noreferrer">
                <HardDriveDownload className="size-4" /> Download for Windows
              </a>
            </Button>
          ...
          <p className="mt-3 text-xs text-muted-foreground/70">
            Free · Windows · installs in seconds. (Not code-signed yet - Windows may say
            “Unknown Publisher”; click <span className="text-foreground/80">More info → Run anyway</span>.)
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="overflow-hidden rounded-2xl border border-border ring-glow">
            <img src={PREVIEW} alt="CairnOS dashboard" className="block w-full" />
          </div>
        </motion.div>
      ...
      {/* Privacy / CTA band */}
      <section id="privacy" className="mx-auto max-w-6xl px-6 pb-20">
        <div className="glass relative overflow-hidden rounded-3xl p-12 text-center">
          ...
          <h2 className="mt-4 text-3xl font-semibold tracking-tight">Stop juggling. Start shipping.</h2>
          ...
          <Button asChild variant="brand" size="lg" className="mt-6 gap-2">
            <a href={RELEASES} target="_blank" rel="noreferrer">
              <HardDriveDownload className="size-4" /> Download CairnOS
            </a>
          </Button>
        </div>
      </section>
